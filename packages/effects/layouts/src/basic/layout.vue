...
// Shared lock screen handler: user-dropdown registers, header calls
const lockHandler = ref<(() => void) | null>(null);
provide('registerLockHandler', (fn: () => void) => {
  lockHandler.value = fn;
});
provide('openLockScreen', () => lockHandler.value?.());
