...
async function fetchData() {
  ...
  try {
    ...
    const response = await requestClient.get<any>('/recruitment/reports/', { params });
...
function handleCreate() {
  router.push({ name: 'RECRUITMENTReportsCreate' });
}

function handleEdit(record: any) {
  router.push({ name: 'RECRUITMENTReportsEdit', params: { id: record.id } });
}

function handleView(record: any) {
  router.push({ name: 'RECRUITMENTReportsView', params: { id: record.id } });
}

async function handleDelete(record: any) {
  try {
    await requestClient.delete(`/recruitment/reports/${record.id}`);
