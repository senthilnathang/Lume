...
async function fetchData() {
  ...
  try {
    ...
    const response = await requestClient.get<any>('/employee/documents/', { params });
...
function handleCreate() {
  router.push({ name: 'EMPLOYEEDocumentsCreate' });
}

function handleEdit(record: any) {
  router.push({ name: 'EMPLOYEEDocumentsEdit', params: { id: record.id } });
}

function handleView(record: any) {
  router.push({ name: 'EMPLOYEEDocumentsView', params: { id: record.id } });
}

async function handleDelete(record: any) {
  try {
    await requestClient.delete(`/employee/documents/${record.id}`);
