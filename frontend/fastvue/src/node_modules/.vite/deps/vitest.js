...
function p(n = false) {
  let e = C(n), i = (r, t, c, o) => {
    let l2 = "", s2 = 0;
    do
      l2 += r.substring(s2, o) + c, s2 = o + t.length, o = r.indexOf(t, s2);
    while (~o);
    return l2 + r.substring(s2);
  }, g = (r, t, c = r) => {
    let o = (l2) => {
      let s2 = String(l2), b2 = s2.indexOf(t, r.length);
      return ~b2 ? r + i(s2, t, c, b2) + t : r + s2 + t;
    };
...
// ../../node_modules/.pnpm/tinyrainbow@2.0.0/node_modules/tinyrainbow/dist/browser.js
var s = p();
...
function l(e, t, r) {
  u(e, t, { value: r, configurable: true, writable: true });
}
...
function M(e, t, r) {
  ...
  let c = false;
  n === "value" && o && !o.value && o.get && (n = "get", c = true, r = o.get());
  let p3;
  ...
  let g = (I) => {
    ...
    n !== "value" && delete O.writable, O[n] = I, u(e, s2, O);
  }, a3 = () => {
    d !== e ? Reflect.deleteProperty(e, s2) : o && !p3 ? u(e, s2, o) : g(p3);
  };
  r || (r = p3);
  let i = E(R(r), r);
  n === "value" && P(i, p3);
...
function E(e, t) {
  ...
  y in t)
    return e;
  let { properties: r, descriptors: s2 } = D(t);
  for (let n of r) {
    let d = s2[n];
    b(e, n) || u(e, n, d);
  }
...
var inspectCustom2 = __name((value, options, type3) => {
...
function closeTo(expected, delta, msg) {
  ...
  const abs = __name((x2) => x2 < 0n ? -x2 : x2, "abs");
...
var _lazyMatch = () => {
  var __lib__ = (() => {
    var m2 = Object.defineProperty, V = Object.getOwnPropertyDescriptor, G = Object.getOwnPropertyNames, T2 = Object.prototype.hasOwnProperty, q = (r, e) => {
      for (var n in e) m2(r, n, { get: e[n], enumerable: true });
    }, H = (r, e, n, a3) => {
      if (e && typeof e == "object" || typeof e == "function") for (let t of G(e)) !T2.call(r, t) && t !== n && m2(r, t, { get: () => e[t], enumerable: !(a3 = V(e, t)) || a3.enumerable });
      return r;
    }, J = (r) => H(m2({}, "__esModule", { value: true }), r), w2 = {};
    q(w2, { default: () => re });
    var A = (r) => Array.isArray(r), d = (r) => typeof r == "function", Q = (r) => r.length === 0, W = (r) => typeof r == "number", K2 = (r) => typeof r == "object" && r !== null, X = (r) => r instanceof RegExp, b2 = (r) => typeof r == "string", h4 = (r) => r === void 0, Y = (r) => {
      ...
      const a3 = { cache: {}, input: r, index: 0, indexMax: 0, options: n, output: [] };
      if (v2(e)(a3) && a3.index === r.length) return a3.output;
      throw new Error(`Failed to parse at index ${a3.indexMax}`);
    }, i = (r, e) => A(r) ? er(r, e) : b2(r) ? ar(r, e) : nr(r, e), er = (r, e) => {
      const n = {};
      for (const a3 of r) {
        if (a3.length !== 1) throw new Error(`Invalid character: "${a3}"`);
        const t = a3.charCodeAt(0);
        n[t] = true;
      }
      return (a3) => {
        const t = a3.index, o = a3.input;
        for (; a3.index < o.length && o.charCodeAt(a3.index) in n; ) a3.index += 1;
        const u2 = a3.index;
        if (u2 > t) {
          if (!h4(e) && !a3.options.silent) {
            const s2 = a3.input.slice(t, u2), c = d(e) ? e(s2, o, String(t)) : e;
            h4(c) || a3.output.push(c);
          }
          a3.indexMax = Math.max(a3.indexMax, a3.index);
        }
        return true;
      };
    }, nr = (r, e) => {
      const n = r.source, a3 = r.flags.replace(/y|$/, "y"), t = new RegExp(n, a3);
      return g((o) => {
        t.lastIndex = o.index;
        const u2 = t.exec(o.input);
        if (u2) {
          if (!h4(e) && !o.options.silent) {
            const s2 = d(e) ? e(...u2, o.input, String(o.index)) : e;
            h4(s2) || o.output.push(s2);
          }
      ...
      if (n.input.startsWith(r, n.index)) {
        if (!h4(e) && !n.options.silent) {
          const t = d(e) ? e(r, n.input, String(n.index)) : e;
          h4(t) || n.output.push(t);
        }
      ...
      return g(_(M2((o) => {
        ...
        for (; u2 < n; ) {
          const s2 = o.index;
          if (!t(o) || (u2 += 1, o.index === s2)) break;
        }
        return u2 >= e;
      })));
    }, tr = (r, e) => C3(r, 0, 1), f4 = (r, e) => C3(r, 0, 1 / 0), x2 = (r, e) => {
      const n = r.map(v2);
      return g(_(M2((a3) => {
        for (let t = 0, o = n.length; t < o; t++) if (!n[t](a3)) return false;
        return true;
      })));
    }, l2 = (r, e) => {
      const n = r.map(v2);
      return g(_((a3) => {
        for (let t = 0, o = n.length; t < o; t++) if (n[t](a3)) return true;
        return false;
      }));
    }, M2 = (r, e = false) => {
      const n = v2(r);
      return (a3) => {
        const t = a3.index, o = a3.output.length, u2 = n(a3);
        return (!u2 || e) && (a3.index = t, a3.output.length !== o && (a3.output.length = o)), u2;
      };
    }, _ = (r, e) => {
      const n = v2(r);
      return n;
      ...
      return (e) => {
        ...
        return (t) => {
          ...
          const u2 = t.index, s2 = (o = t.cache)[a3] || (o[a3] = /* @__PURE__ */ new Map()), c = s2.get(u2);
          ...
          if (c) return t.index = c.index, c.output?.length && t.output.push(...c.output), true;
          {
            ...
            if (n(t)) {
              const D2 = t.index, U = t.output.length;
              if (U > Z) {
                const ee = t.output.slice(Z, U);
                s2.set(u2, { index: D2, output: ee });
              } else s2.set(u2, D2);
              return true;
      ...
      let e;
      return (n) => (e || (e = v2(r())), e(n));
    }, v2 = Y((r) => {
      if (d(r)) return Q(r) ? E2(r) : r;
      if (b2(r) || X(r)) return i(r);
      if (A(r)) return x2(r);
      if (K2(r)) return l2(Object.values(r));
      throw new Error("Invalid rule");
    }), P2 = "abcdefghijklmnopqrstuvwxyz", ir = (r) => {
      let e = "";
      for (; r > 0; ) {
        const n = (r - 1) % 26;
      ...
      let e = 0;
      for (let n = 0, a3 = r.length; n < a3; n++) e = e * 26 + P2.indexOf(r[n]) + 1;
      return e;
    }, S2 = (r, e) => {
      ...
      for (; r <= e; ) n.push(r++);
      return n;
    }, or = (r, e, n) => S2(r, e).map((a3) => String(a3).padStart(n, "0")), R2 = (r, e) => S2(O(r), O(e)).map(ir), p3 = (r) => r, z = (r) => ur((e) => rr(e, r, { memoization: false }).join("")), ur = (r) => {
      const e = {};
      return (n) => e[n] ?? (e[n] = r(n));
    }, sr = i(/^\*\*\/\*$/, ".*"), cr = i(/^\*\*\/(\*)?([ a-zA-Z0-9._-]+)$/, (r, e, n) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}`), lr = i(/^\*\*\/(\*)?([ a-zA-Z0-9._-]*)\{([ a-zA-Z0-9._-]+(?:,[ a-zA-Z0-9._-]+)*)\}$/, (r, e, n, a3) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}(?:${a3.replaceAll(",", "|").replaceAll(".", "\\.")})`), y2 = i(/\\./, p3), pr = i(/[$.*+?^(){}[\]\|]/, (r) => `\\${r}`), vr = i(/./, p3), hr = i(/^(?:!!)*!(.*)$/, (r, e) => `(?!^${L(e)}$).*?`), dr = i(/^(!!)+/, ""), fr = l2([hr, dr]), xr = i(/\/(\*\*\/)+/, "(?:/.+/|/)"), gr = i(/^(\*\*\/)+/, "(?:^|.*/)"), mr = i(/\/(\*\*)$/, "(?:/.*|$)"), _r = i(/\*\*/, ".*"), j2 = l2([xr, gr, mr, _r]), Sr = i(/\*\/(?!\*\*\/)/, "[^/]*/"), yr = i(/\*/, "[^/]*"), N = l2([Sr, yr]), k2 = i("?", "[^/]"), $r = i("[", p3), wr = i("]", p3), Ar = i(/[!^]/, "^/"), br = i(/[a-z]-[a-z]|[0-9]-[0-9]/i, p3), Cr = i(/[$.*+?^(){}[\|]/, (r) => `\\${r}`), Mr = i(/[^\]]/, p3), Er = l2([y2, Cr, br, Mr]), B2 = x2([$r, tr(Ar), f4(Er), wr]), Pr = i("{", "(?:"), Or = i("}", ")"), Rr = i(/(\d+)\.\.(\d+)/, (r, e, n) => or(+e, +n, Math.min(e.length, n.length)).join("|")), zr = i(/([a-z]+)\.\.([a-z]+)/, (r, e, n) => R2(e, n).join("|")), jr = i(/([A-Z]+)\.\.([A-Z]+)/, (r, e, n) => R2(e.toLowerCase(), n.toLowerCase()).join("|").toUpperCase()), Nr = l2([Rr, zr, jr]), I = x2([Pr, Nr, Or]), kr = i("{", "(?:"), Br = i("}", ")"), Ir = i(",", "|"), Fr = i(/[$.*+?^(){[\]\|]/, (r) => `\\${r}`), Lr = i(/[^}]/, p3), Zr = E2(() => F), Dr = l2([j2, N, k2, B2, I, Zr, y2, Fr, Ir, Lr]), F = x2([kr, f4(Dr), Br]), Ur = f4(l2([sr, cr, lr, fr, j2, N, k2, B2, I, F, y2, pr, vr])), Vr = Ur, Gr = z(Vr), L = Gr, Tr = i(/\\./, p3), qr = i(/./, p3), Hr = i(/\*\*\*+/, "*"), Jr = i(/([^/{[(!])\*\*/, (r, e) => `${e}*`), Qr = i(/(^|.)\*\*(?=[^*/)\]}])/, (r, e) => `${e}*`), Wr = f4(l2([Tr, Hr, Jr, Qr, qr])), Kr = Wr, Xr = z(Kr), Yr = Xr, $ = (r, e) => {
      const n = Array.isArray(r) ? r : [r];
      if (!n.length) return false;
      const a3 = n.map($.compile), t = n.every((s2) => /(\/(?:\*\*)?|\[\/\])$/.test(s2)), o = e.replace(/[\\\/]+/g, "/").replace(/\/$/, t ? "/" : "");
      return a3.some((s2) => s2.test(o));
    };
...
var toNamespacedPath = function(p3) {
  return normalizeWindowsPath2(p3);
};
var extname = function(p3) {
  if (p3 === "..") return "";
  const match = _EXTNAME_RE.exec(normalizeWindowsPath2(p3));
...
var dirname = function(p3) {
  const segments = normalizeWindowsPath2(p3).replace(/\/$/, "").split("/").slice(0, -1);
  if (segments.length === 1 && _DRIVE_LETTER_RE.test(segments[0])) {
    segments[0] += "/";
  }
  return segments.join("/") || (isAbsolute2(p3) ? "/" : ".");
};
var format3 = function(p3) {
  const ext = p3.ext ? p3.ext.startsWith(".") ? p3.ext : `.${p3.ext}` : "";
  const segments = [p3.root, p3.dir, p3.base ?? (p3.name ?? "") + ext].filter(
    Boolean
  );
  return normalizeWindowsPath2(
    p3.root ? resolve2(...segments) : segments.join("/")
  );
};
var basename = function(p3, extension) {
  const segments = normalizeWindowsPath2(p3).split("/");
  let lastSegment = "";
...
var parse = function(p3) {
  const root = _PATH_ROOT_RE.exec(p3)?.[0]?.replace(/\\/g, "/") || "";
  const base = basename(p3);
...
// ../../node_modules/.pnpm/vitest@3.2.4_@types+node@24.10.9_happy-dom@17.6.3_jiti@2.6.1_jsdom@26.1.0_msw@2.12.7_@t_cc8dc2df2a7ae9ceac1ce82b613a4055/node_modules/vitest/dist/chunks/utils.XdZDrNZV.js
...
// ../../node_modules/.pnpm/vitest@3.2.4_@types+node@24.10.9_happy-dom@17.6.3_jiti@2.6.1_jsdom@26.1.0_msw@2.12.7_@t_cc8dc2df2a7ae9ceac1ce82b613a4055/node_modules/vitest/dist/chunks/_commonjsHelpers.BFTU3MAI.js
...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString = (await import("./magic-string.es-RRF7AHA7.js")).default;
...
var naturalCompare = getDefaultExportFromCjs4(naturalCompareExports);
...
// ../../node_modules/.pnpm/vitest@3.2.4_@types+node@24.10.9_happy-dom@17.6.3_jiti@2.6.1_jsdom@26.1.0_msw@2.12.7_@t_cc8dc2df2a7ae9ceac1ce82b613a4055/node_modules/vitest/dist/chunks/date.Bq6ZW5rf.js
var RealDate = Date;
var now2 = null;
...
// ../../node_modules/.pnpm/vitest@3.2.4_@types+node@24.10.9_happy-dom@17.6.3_jiti@2.6.1_jsdom@26.1.0_msw@2.12.7_@t_cc8dc2df2a7ae9ceac1ce82b613a4055/node_modules/vitest/dist/chunks/vi.bdSIJ99Y.js
var unsupported = [
  "matchSnapshot",
  "toMatchSnapshot",
...
var Subset = getDefaultExportFromCjs3(chaiSubsetExports);
...
// ../../node_modules/.pnpm/vitest@3.2.4_@types+node@24.10.9_happy-dom@17.6.3_jiti@2.6.1_jsdom@26.1.0_msw@2.12.7_@t_cc8dc2df2a7ae9ceac1ce82b613a4055/node_modules/vitest/dist/chunks/benchmark.CYdenmiT.js
...
// ../../node_modules/.pnpm/vitest@3.2.4_@types+node@24.10.9_happy-dom@17.6.3_jiti@2.6.1_jsdom@26.1.0_msw@2.12.7_@t_cc8dc2df2a7ae9ceac1ce82b613a4055/node_modules/vitest/dist/chunks/index.CdQS2e2Q.js
...
// ../../node_modules/.pnpm/vitest@3.2.4_@types+node@24.10.9_happy-dom@17.6.3_jiti@2.6.1_jsdom@26.1.0_msw@2.12.7_@t_cc8dc2df2a7ae9ceac1ce82b613a4055/node_modules/vitest/dist/index.js
