...
// ../../node_modules/.pnpm/@vueuse+integrations@14.1.0_async-validator@4.2.5_axios@1.13.4_change-case@5.4.4_nprogr_a551b126fe0a6d60fc365d13bd310ea1/node_modules/@vueuse/integrations/dist/useQRCode-DtYpMi-Z.js
var import_qrcode = __toESM(require_browser(), 1);
function useQRCode(text, options) {
  const src = toRef(text);
  const result = shallowRef("");
  watch(src, async (value) => {
    if (src.value && isClient) result.value = await import_qrcode.default.toDataURL(value, options);
  }, { immediate: true });
  return result;
}
export {
