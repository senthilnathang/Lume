...
async function fetchData() {
  ...
  try {
    ...
    const response = await requestClient.get<any>('/employee/settings/', { params });
...
function handleCreate() {
  router.push({ name: 'EMPLOYEESettingsCreate' });
}

function handleEdit(record: any) {
  router.push({ name: 'EMPLOYEESettingsEdit', params: { id: record.id } });
}

function handleView(record: any) {
  router.push({ name: 'EMPLOYEESettingsView', params: { id: record.id } });
}

async function handleDelete(record: any) {
  try {
    await requestClient.delete(`/employee/settings/${record.id}`);
