...
async function fetchData() {
  ...
  try {
    ...
    const response = await requestClient.get<any>('/recruitment/interviews/', { params });
...
function handleCreate() {
  router.push({ name: 'RECRUITMENTInterviewsCreate' });
}

function handleEdit(record: any) {
  router.push({ name: 'RECRUITMENTInterviewsEdit', params: { id: record.id } });
}

function handleView(record: any) {
  router.push({ name: 'RECRUITMENTInterviewsView', params: { id: record.id } });
}

async function handleDelete(record: any) {
  try {
    await requestClient.delete(`/recruitment/interviews/${record.id}`);
